/* ============================================================
   Operator login page.
   POST /operators/login -> store JWT -> go to the dashboard.
   Relies on helpers from common.js (loaded first).
   ============================================================ */

"use strict";

const DASHBOARD_URL = "/operator-dashboard.html";
