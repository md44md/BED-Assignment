/* ============================================================
   Menu Management — stall owner console.
   Protected page: no valid token -> redirect to the login page.

   Talks to the back-end RESTful API (all routes need a JWT):
     GET    /menuitems              — returns a raw array
     POST   /menuitems              — returns the raw new item
     PUT    /menuitems/:id          — returns the raw updated item
     DELETE /menuitems/:id
